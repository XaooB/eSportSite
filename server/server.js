...
router.get('/admin/articles/edit-article', requireAdmin, articleRouter.editArticle);
router.post('/admin/articles/edit-article', requireAdmin, articleRouter.postEditArticle);

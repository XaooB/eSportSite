...
exports.deleteComment = (req, res) => {
    Comment.find({
        ...
        res.json({
            "Error": "Wystąpił błąd podczas próby usunięcia komentarza. Sprawdź konsolę."
        })
    })
}
...
exports.deleteArticle = (req, res) => {
    Article.find({
        ...
        console.log(err.mesage);
        res.json({
            "Error": "Wystąpił błąd podczas próby usunięcia artykułu. Sprawdź konsolę."
        })
    })
}
...
exports.deleteUser = (req, res) => {
    ...
    User.findOne({
        ...
        res.json({
            "Error": "Wystąpił błąd podczas próby usunięcia użytkownika. Sprawdź konsolę."
        })
    })
}
...
exports.banUser = (req, res) => {
    ...
    User.findOne({
        ...
        console.log(err.message);
        res.json({
            "Error": "Wystąpił błąd podczas próby zbanowania użytkownika. Sprawdź konsolę."
        })
    })
}
    ...
    User.findOne({
        ...
        if (result.rank !== 'admin') {
            return User.findOne({
                ...
                console.log(err.message);
                res.json({
                    "Error": "Wystąpił błąd podczas próby nadania praw użytkownikowi. Sprawdź konsolę."
                })
            })
        } else {
            res.json({
